                ...
                <tbody>
					...
					<tr>
						<td class="label">
							...
							<span class="description"><?php THWCFE_i18n::et('You can transfer the saved settings data between different installs by copying the text inside the text box. To import data from another install, replace the data in the text box with the one from another install and click "Save Settings".'); ?></span>
						</td>
						<td class="tip"></td>
						<td class="field">
