	...
	public function render_sections() {
		...
		foreach( $sections as $name => $section ){
			...
			if(THWCFE_Utils_Section::is_custom_section($section)){
                ...
                <li>
					<span class="s_copy_btn dashicons dashicons-admin-page tips" data-tip="<?php THWCFE_i18n::et('Duplicate Section'); ?>" onclick='thwcfeOpenCopySectionForm(<?php echo $props_json; ?>)'></span>
				</li>
				<li>
		...
		echo '<li><a href="javascript:thwcfeOpenNewSectionForm()" class="btn btn-tiny btn-primary ml-30">+ '. THWCFE_i18n::t('Add new section') .'</a></li>';
		echo '</ul>';		
	...
	private function render_actions_row($section){
		...
		?>
            <th colspan="5">
                ...
                <button type="button" class="btn btn-small" onclick="thwcfeRemoveSelectedFields()"><?php  THWCFE_i18n::et('Remove'); ?></button>
                <button type="button" class="btn btn-small" onclick="thwcfeEnableSelectedFields()"><?php  THWCFE_i18n::et('Enable'); ?></button>
                <button type="button" class="btn btn-small" onclick="thwcfeDisableSelectedFields()"><?php THWCFE_i18n::et('Disable'); ?></button>
            </th>
            <th colspan="5">
                <input type="submit" name="save_fields" class="btn btn-small btn-primary" value="<?php THWCFE_i18n::et('Save changes') ?>" style="float:right" />
<!--                 <input type="submit" name="reset_fields" class="btn btn-small" value="<?php THWCFE_i18n::et('Reset to default fields') ?>" style="float:right; margin-right: 5px;" 
		...
		?>
			<th colspan="5">
                <button type="button" class="btn btn-small" disabled ><?php THWCFE_i18n::et('+ Add field'); ?></button>
                <button type="button" class="btn btn-small" disabled ><?php THWCFE_i18n::et('Remove'); ?></button>
                <button type="button" class="btn btn-small" disabled ><?php THWCFE_i18n::et('Enable'); ?></button>
                <button type="button" class="btn btn-small" disabled ><?php THWCFE_i18n::et('Disable'); ?></button>
            </th>
            <th colspan="5">
                <input type="submit" name="save_fields" class="btn btn-small" disabled value="<?php THWCFE_i18n::et('Save changes') ?>" style="float:right" />
<!--                 <input type="submit" name="reset_fields" class="btn btn-small" value="<?php THWCFE_i18n::et('Reset to default fields') ?>" style="float:right; margin-right: 5px;" 
                onclick="return confirm('Are you sure you want to reset to default fields? all your changes will be deleted.');"/> -->
				<input type="submit" name="bulk_action" class="btn btn-small" value="<?php _e('Apply') ?>" style="float:right; margin-right: 5px;" 
				                onclick="thwcfeApplyBulkAction(this, event)"/>                
	...
	private function render_content(){
		...
		if(empty($thwcfe_all_section_data)){
			$reset_to_default = '<a href="#" data-nonce="'.wp_create_nonce('reset-to-default-nonce').'" onclick="thwcfeRestoreDefaultFields(event, this);"> ' . __('Else click here to get the default fields.') . '</a>';
		}
				...
				if(THWCFE_Utils_Section::is_valid_section($section) && THWCFE_Utils_Section::has_fields($section)){
					...
					<tr>
						<td colspan="10" class="empty-msg-row">
							<?php THWCFE_i18n::et('No checkout fields found. Click on Add Field button to create new fields.'); ?>
